...
## Drivers and loaders
sudo dnf install -y vulkan-loader vulkan-loader-devel vulkan-headers vulkan-validation-layers

## Dev tools
sudo dnf install -y glslang glslang-devel spirv-tools spirv-tools-devel spirv-headers-devel 

# ====== Setup vulkan ICD for nvidia cards ======
sudo mkdir -p /etc/vulkan/icd.d

sudo dnf install nvidia-driver-libs --setopt=install_weak_deps=False
